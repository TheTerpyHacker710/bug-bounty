        ...
        <app-layout>
            ...
            <div class="py-6 px-6">
                <div class="max-w-full mx-auto">
                    <div class="grid gap-4 grid-cols-1 lg:grid-cols-8">

                        <span class="bg-white col-span-1 lg:col-span-2 shadow-xl rounded-lg h-full">
                            <stats :chart="chart" :leaderboard="leaderboard"/>
                        </span>

                        <span class="bg-white col-span-1 lg:col-span-4 shadow-xl rounded-lg h-full">
                            <active-jobs :activeReports="activeReports" :activeVerifications="activeVerifications"/>
                        </span>

                        <span class="bg-white col-span-1 lg:col-span-2 shadow-xl rounded-lg">
